...
- [pGC 局所類体論: ★★★★★★★★★★φ_1は既約——K(α)/Kは次数q-1の完全分岐拡大(Eisenstein判定法)](pgc-lubin-tate-existence-progress.md) — Found/PGC/LubinTateActionWeierstrass.lean::irreducible_iteratedLubinTatePrimitive_one が2026-09-04に完成。Lubin-Tate理論の核心的定理。n≥2への一般化(φ_n/φ_{n-1}のEisenstein性)は別途の課題。残るはΛ_n本体の𝒪_K加群構造・Galois群計算・相互律写像そのものの構成という大きな仕事。
