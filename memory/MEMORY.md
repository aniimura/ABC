...
- [pGC 局所類体論: ★★★★★★★★★★★★Newton polygon+ψ_n・ψ_mの互いの素性・分離性完成——D_n分離性の材料が出揃った](pgc-lubin-tate-existence-progress.md) — Found/PGC/LubinTatePsiNorm.lean::isCoprime_iteratedLubinTatePsi・separable_iteratedLubinTatePsi_map_carrier が2026-09-04に完成。残るはD_n=X・ψ_1・…・ψ_n全体のsquarefree性の組み立て・K(Λ_n)の正規性・Galois群計算Gal(L_n/K)≅(𝒪_K/π^n)^×・相互律写像そのものの構成という仕事。
