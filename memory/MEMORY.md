...
- [pGC 局所類体論: Lubin-Tate存在補題の帰納法1ステップ全体がsorry無しで完成](pgc-lubin-tate-existence-progress.md) — Found/PGC/LubinTateStepAssembly.lean(exists_next_step)、可除性・f側/g側線形化の3部品を実際に組み合わせた。残るはNat.recでの無限次までの構成のみ。2026-09-04。
