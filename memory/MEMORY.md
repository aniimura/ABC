...
- [pGC 局所類体論: Lubin-Tate形式群法則3性質・𝒪_K作用への拡張の節目(1)(2)(2b)がすべてsorry無しで完成](pgc-lubin-tate-existence-progress.md) — Found/PGC/LubinTateActionAdd.lean::LubinTateAction_add([a+b]_f=F_f([a]_f,[b]_f))が2026-09-04に完成し、a↦[a]_fの環準同型性(乗法・加法とも)が完成。残るはtorsion点・相互律写像そのものの構成という大きな仕事。
