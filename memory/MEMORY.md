...
- [pGC 不分岐拡大理論: ユーザー承認を得て着手、スケルトン(定義のみ)の第一歩をcommit](pgc-unramified-extension-progress.md) — 2026-09-05。Found/PGC/UnramifiedExtension.lean(residueDegree・finiteDimensional_adjoin_zero)。HenselianLocalRing・Ideal.ramificationIdx・GaloisField等の関連mathlib道具を調査済み、「有限体の代数閉包のGalois群≅Ẑ」はmathlibに不在と確認。次: 退化した基点(x=0)の不分岐性確認から。
