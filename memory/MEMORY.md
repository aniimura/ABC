...
- [pGC 局所類体論: Lubin-Tate形式群法則3性質・𝒪_K作用への拡張の節目(1)(2)(1変数存在定理・自己準同型性)がsorry無しで完成](pgc-lubin-tate-existence-progress.md) — Found/PGC/LubinTateActionEndomorphism.lean::formalGroupLaw_endomorphism_of_action(F_f([a]X,[a]Y)=[a]F_f(X,Y))が2026-09-04に完成。残るは環準同型そのもの・torsion点・相互律写像そのものの構成という大きな仕事。
