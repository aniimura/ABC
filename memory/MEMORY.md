...
- [pGC 局所類体論: Lubin-Tate形式群法則の存在・単位元則2つ・可換律・結合律の土台(任意変数一意性補題)がsorry無しで完成](pgc-lubin-tate-existence-progress.md) — Found/PGC/LubinTateGeneralUniqueness.lean::mvPowerSeries_uniqueness_general(任意有限添字型σ、Fin 3含む)が2026-09-04に完成。残るは結合律の最後の2段・torsion点・相互律写像そのものの構成。
