...
- [pGC 局所類体論: Lubin-Tate形式群法則3性質・𝒪_K作用への拡張の節目(1)(2)+環準同型の乗法側がsorry無しで完成](pgc-lubin-tate-existence-progress.md) — Found/PGC/LubinTateActionMul.lean::LubinTateAction_comp([ab]_f=[a]_f∘[b]_f)が2026-09-04に完成。残るは環準同型の加法側・torsion点・相互律写像そのものの構成という大きな仕事。
