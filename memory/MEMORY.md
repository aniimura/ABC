...
- [pGC 局所類体論: Lubin-Tate形式群法則3性質・𝒪_K作用への拡張の節目(1)(2)(2b)完成+節目(3)n≤mならD_n∣D_m(Λ_n⊆Λ_m)まで到達](pgc-lubin-tate-existence-progress.md) — Found/PGC/LubinTateActionWeierstrass.lean::iteratedLubinTateDistinguished_dvd_of_le が2026-09-04に完成(Weierstrass分解の一意性を使う純粋代数的議論、代数閉体での根の個数q^n・q^n-1も既出)。残るは分離性(根が相異なること)・𝒪_K加群構造・相互律写像そのものの構成という大きな仕事。
