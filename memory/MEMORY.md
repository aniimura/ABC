...
- [pGC 局所類体論: Lubin-Tate形式群法則の3性質(単位元則2つ・可換律・結合律)が全てsorry無しで完成](pgc-lubin-tate-existence-progress.md) — Found/PGC/LubinTateAssociativity.lean::formalGroupLaw_associative(F_f(F_f(X,Y),Z)=F_f(X,F_f(Y,Z)))が2026-09-04に完成。残るはtorsion点・相互律写像そのものの構成という大きな仕事。
