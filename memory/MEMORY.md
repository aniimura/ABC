...
- [pGC 局所類体論: Lubin-Tate存在補題の帰納法1ステップの3部品(f側線形化・g側線形化・可除性)がsorry無しで揃った](pgc-lubin-tate-existence-progress.md) — Found/PGC/LubinTateLinearization.lean・LubinTateGLinearization.lean・LubinTateDivisibility.lean・LubinTateStep.lean・ValuationRingDVR.lean。残るはNat.recでの組み立てのみ。2026-09-04。
