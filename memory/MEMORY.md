...
- [pGC 局所類体論: ★★★★★★★★★★★★Newton polygon完成——ψ_n・ψ_m(n≠m)は共通根を持たない](pgc-lubin-tate-existence-progress.md) — Found/PGC/LubinTatePsiNorm.lean::no_common_root_iteratedLubinTatePsi が2026-09-04に完成(spectralNorm経由、実在のp進局所体K:PAdicLocalField pについて)。異なる段の捩れ点が互いに素な多項式の根であるという古典的核心補題を確立。残るはD_n全体の分離性・K(Λ_n)の正規性・Galois群計算Gal(L_n/K)≅(𝒪_K/π^n)^×・相互律写像そのものの構成という仕事。
