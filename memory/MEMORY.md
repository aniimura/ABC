...
- [pGC 局所類体論: Lubin-Tate形式群法則3性質・𝒪_K作用への拡張の節目(1)(2)(2b)完成+節目(3)着手([π^n]_f=fのn回自己合成・mod πでX^(q^n))](pgc-lubin-tate-existence-progress.md) — Found/PGC/LubinTateActionPiPow.lean::iteratedLubinTate_map_residue が2026-09-04に完成。mathlibにWeierstrass標準分解(RingTheory/PowerSeries/WeierstrassPreparation.lean)が既に整備済みと発見、節目(3)の加速要因。残るはtorsion点構成本体・相互律写像そのものの構成という大きな仕事。
